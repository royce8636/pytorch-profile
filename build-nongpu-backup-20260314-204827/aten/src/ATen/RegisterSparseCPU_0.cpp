...
namespace {
namespace {
at::Tensor wrapper_SparseCPU__view_as_real(const at::Tensor & self) {
    // No device check
  // DeviceGuard omitted
...
TORCH_LIBRARY_IMPL(aten, SparseCPU, m) {
    m.impl("view_as_real",
TORCH_FN(wrapper_SparseCPU__view_as_real));
}
} // anonymous namespace
namespace sparsecpu {
at::Tensor view_as_real(const at::Tensor & self) {
return wrapper_SparseCPU__view_as_real(self);
}
} // namespace sparsecpu
} // namespace at
namespace at {
...
namespace {
namespace {
at::Tensor wrapper_SparseCPU__view_as_complex(const at::Tensor & self) {
    // No device check
  // DeviceGuard omitted
...
TORCH_FN(wrapper_SparseCPU__view_as_complex));
}
} // anonymous namespace
namespace sparsecpu {
at::Tensor view_as_complex(const at::Tensor & self) {
return wrapper_SparseCPU__view_as_complex(self);
}
} // namespace sparsecpu
} // namespace at
namespace at {
