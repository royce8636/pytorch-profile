...
namespace {
namespace {
at::Tensor wrapper_SparseCUDA__view_as_real(const at::Tensor & self) {
  std::optional<Device> common_device = std::nullopt;
(void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, self, "wrapper_SparseCUDA__view_as_real", "self");
  const OptionalDeviceGuard device_guard(device_of(self));
  return at::native::view_as_real_sparse(self);
}
} // anonymous namespace
TORCH_LIBRARY_IMPL(aten, SparseCUDA, m) {
    m.impl("view_as_real",
TORCH_FN(wrapper_SparseCUDA__view_as_real));
}
} // anonymous namespace
namespace sparsecuda {
at::Tensor view_as_real(const at::Tensor & self) {
return wrapper_SparseCUDA__view_as_real(self);
}
} // namespace sparsecuda
} // namespace at
namespace at {
...
namespace {
namespace {
at::Tensor wrapper_SparseCUDA__view_as_complex(const at::Tensor & self) {
  std::optional<Device> common_device = std::nullopt;
(void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, self, "wrapper_SparseCUDA__view_as_complex", "self");
  const OptionalDeviceGuard device_guard(device_of(self));
  return at::native::view_as_complex_sparse(self);
}
} // anonymous namespace
TORCH_LIBRARY_IMPL(aten, SparseCUDA, m) {
    m.impl("view_as_complex",
TORCH_FN(wrapper_SparseCUDA__view_as_complex));
}
} // anonymous namespace
namespace sparsecuda {
at::Tensor view_as_complex(const at::Tensor & self) {
return wrapper_SparseCUDA__view_as_complex(self);
}
} // namespace sparsecuda
} // namespace at
namespace at {
