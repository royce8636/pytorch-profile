    ...
    *,
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "step_0_compute_graph.dot, ggml_profile_node_records.csv, runtime "
            "node/edge metadata, tensor metadata, and a manifest. Requires "
            "--dot-level llamasim-runtime or all."
        ),
    )
    parser.add_argument(
        "--component",
...
def main(
    *,
    ...
    _unprof_out = run_pipeline(pipe, args, generator)
    sdxl_common.synchronize_device(device)
    ...
    if output_paths.llamasim_output_dir is not None:
        ...
        calibrated_bundle_dir = sdxl_common.write_calibrated_bundle(
